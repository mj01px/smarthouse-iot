...
const WALLS = [
  ...
  // { wallId: "parede-baixo-banheiro", label: "parede-baixo-banheiro", x:527, y:793, w:280, h:23 },
  // { wallId: "sala-banheiro", label: "sala-banheiro", x:584, y:598, w:19, h:196 },
  // { wallId: "pia", label: "pia", x:605, y:745, w:65, h:45 },
  // { wallId: "banheira", label: "banheira", x:711, y:670, w:77, h:117 },
  // { wallId: "privada", label: "privada", x:734, y:590, w:48, h:43 },
  // { wallId: "parede-direita", label: "parede-direita", x:773, y:490, w:39, h:323 },
  // { wallId: "cozinha-banheiro", label: "cozinha-banheiro", x:586, y:489, w:218, h:37 },
  // { wallId: "quinha-cozinha", label: "quinha-cozinha", x:585, y:443, w:20, h:87 },
  // { wallId: "pia-cozinha", label: "pia-cozinha", x:607, y:446, w:179, h:44 },
  // { wallId: "pia-cozinha", label: "pia-cozinha", x:730, y:346, w:53, h:141 },
  // { wallId: "parede-direita", label: "parede-direita", x:783, y:197, w:27, h:288 },
  // { wallId: "fogao-geladeira", label: "fogao-geladeira", x:524, y:216, w:260, h:100 },
  // { wallId: "parede-cima", label: "parede-cima", x:219, y:195, w:592, h:57 },
  // { wallId: "cama", label: "cama", x:289, y:243, w:137, h:177 },
  // { wallId: "abajur", label: "abajur", x:253, y:240, w:35, h:49 },
  // { wallId: "abajur", label: "abajur", x:425, y:249, w:39, h:42 },
  // { wallId: "parede-quartocozinha", label: "parede-quartocozinha", x:505, y:217, w:16, h:302 },
  //
